...
```bash
sudo apt-get install -y python3-pip python3-scipy numpy swig
...
### bench_scipy1.py — Scenarios 1 & 2: spsolve and factorized (UMFPACK vs SuperLU)

```bash
python3 bench_scipy1.py
```

Compares UMFPACK and SuperLU performance for sparse nonsymmetric matrices
of sizes n=500, 1000, 2000, 5000 with 1% density.

### bench_scipy2.py — Scenario 3: CHOLMOD vs UMFPACK vs dense Cholesky
